...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename', type=str, default='cfg/register_camera_azure_kinect_local.yaml', help='filename of a YAML configuration for registration')
