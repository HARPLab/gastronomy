...
def main():
    ...
    parser.add_argument('--vegType_labels_filename', type = str, default = 'vegNames_numerical.txt') 
...
def run_training_process(process_id, model, transform, label_transform, args):
    ...
    '''
    # Labels for vegType data, nx1 array: num_samples x vegType label
    vegType_labels_filename = args.vegType_labels_filename #'/home/test2/Documents/ISER-2020/playing_with_food/data_analysis/vegNames_numerical.txt'
    labels = np.genfromtxt(vegType_labels_filename)   
    print('shape of vegType labels', labels.shape)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_rate == 0:
            ...
            utils.save_checkpoint({
                ...
                'best_loss': best_loss,
                'optimizer' : optimizer.state_dict(),
            }, is_best, args.save_path, 'checkpt_epoch' +str(epoch))
