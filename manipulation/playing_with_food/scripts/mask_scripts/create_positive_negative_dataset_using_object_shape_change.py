...
changes_in_object_shape = ending_object_images - starting_object_images
...
flattened_changes_in_object_shape = changes_in_object_shape.reshape((449,-1))

distances = distance.pdist(flattened_changes_in_object_shape)
...
pick = open("positive_negative_labels_using_change_in_object_shape.pkl",'wb')
