...
distances = distance.pdist(object_size_changes)
...
for trial_idx in trials_with_object_in_ending_image[0]:
	...
	print(np.intersect1d(positive_samples[0], trials_with_no_object_in_ending_image[0]))
...
pick = open("positive_negative_labels_using_change_in_object_size.pkl",'wb')
