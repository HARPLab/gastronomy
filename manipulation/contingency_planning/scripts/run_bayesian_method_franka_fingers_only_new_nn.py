...
if __name__ == "__main__":
    ...
    parser.add_argument('--contingency_nn_dir', type=str, default='same_blocks/pick_up/')
    ...
    for current_block_id in range(num_blocks):
        ...
        for i in range(args.num_trials):
            ...
            if block_data[skill_num] == 1:
                ...
                new_skill_failure_probabilities = success_failure_contingency_nn.predict(relative_transforms).reshape(-1)
                ...
                new_skill_success_probabilities = failure_success_contingency_nn.predict(relative_transforms).reshape(-1)
