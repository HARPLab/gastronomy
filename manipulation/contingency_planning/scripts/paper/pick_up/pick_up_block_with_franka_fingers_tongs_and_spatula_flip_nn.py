...
if __name__ == "__main__":
    ...
    #np.save('baseline/franka_fingers_500.npy', sorted_x_y_thetas)
    ...
    probabilities = probabilities[sorted_idx].reshape(-1,1)
    sorted_x_y_thetas = sorted_x_y_thetas[:500,:]
    #np.save('baseline/tong_overhead_500.npy', sorted_x_y_thetas)
    #probabilities = probabilities[:500] 
    ...
    #np.save('baseline/tong_side_500.npy', sorted_x_y_theta_dist_tilts)
    #probabilities = probabilities[:500] 
    ...
    probabilities = probabilities[sorted_idx].reshape(-1,1)
    sorted_x_y_theta_dist_tilts = sorted_x_y_theta_dist_tilts[:500,:]
    #np.save('baseline/spatula_tilted_500.npy', sorted_x_y_theta_dist_tilts)
    #probabilities = probabilities[:500] 
