...
if __name__ == "__main__":
    ...
    if args.inputs is None:
        ...
        x_y_theta_tilt_dists = input_data['X']
        print(x_y_theta_tilt_dists.shape)
        ...
        if len(nonzero_trials[0]) == 0:
            ...
            x_y_theta_tilt_dists = x_y_theta_tilt_dists[nonzero_trials[0],:]
    ...
    policy = PickUpURDFTiltedPolicy(franka, 'franka0', urdf, 'urdf0', n_envs, x_y_theta_tilt_dists)
