...
from tong_policies import PickUpBlockSideOnlyPolicy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--baseline_inputs', '-bi', type=str, default='baseline/tongs_side_500.npy')
    parser.add_argument('--inputs', '-i', type=str, default='same_block_data/successful_lift_inputs_pick_up_only_with_tongs_side.npy')
    ...
    parser.add_argument('--data_dir', '-dd', type=str, default='baseline/pick_up/tongs_side/')
    ...
    policy = PickUpBlockSideOnlyPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_theta_tilt_dists)
