...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputs', '-i', type=str, default='baseline/tongs_overhead_500.npy')
    ...
    parser.add_argument('--data_dir', '-dd', type=str, default='baseline/pick_up/tongs_overhead/')
    ...
    policy = PickUpBlockOverheadOnlyPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_thetas)
