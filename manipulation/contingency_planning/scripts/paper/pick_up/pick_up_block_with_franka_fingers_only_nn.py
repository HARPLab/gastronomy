...
if __name__ == "__main__":
    ...
    parser.add_argument('--grasp_nn', type=str, default='same_block_data/franka_fingers_pick_up_only_trained_model.h5')
    parser.add_argument('--failure_contingency_nn', type=str, default='same_block_data/franka_fingers_pick_up_only_failure_contingency_model.h5')
    parser.add_argument('--success_contingency_nn', type=str, default='same_block_data/franka_fingers_pick_up_only_success_contingency_model.h5')
    ...
    policy = PickUpBlockPolicy(franka, 'franka0', block, 'block0', n_envs, resampled_points)
