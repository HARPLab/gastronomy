...
if __name__ == "__main__":
    ...
    x_y_z_theta_dists = get_random_x_y_z_theta_dists(num_iterations)
    x_y_z_rx_ry_rz = get_random_x_y_z_rx_ry_rz(num_iterations)

    policy = PickUpBlockFlatPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_z_theta_dists, x_y_z_rx_ry_rz)
    ...
    np.savez(save_file_name, x_y_z_theta_dists=x_y_z_theta_dists, 
