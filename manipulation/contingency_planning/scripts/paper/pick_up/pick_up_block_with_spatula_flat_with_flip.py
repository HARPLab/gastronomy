...
from spatula_policies import PickUpBlockFlatWithFlipPolicy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputs', '-i', type=str)#, default='same_block_data/successful_lift_inputs_pick_up_only_with_spatula_flat.npy')
    ...
    policy = PickUpBlockFlatWithFlipPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_theta_dists)
    ...
    save_file_name = args.data_dir+'block'+str(args.block_num)+'_pick_up_block_with_spatula_flat_with_flip.npz'
