...
from tong_policies import PickUpBlockOverheadPolicy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputs', '-i', type=str)#, default='same_block_data/successful_lift_inputs_tongs_overhead.npy')
    ...
    policy = PickUpBlockOverheadPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_z_thetas, x_y_z_rx_ry_rz)
