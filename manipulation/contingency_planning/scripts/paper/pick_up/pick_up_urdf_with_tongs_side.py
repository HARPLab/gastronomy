...
from tong_policies import PickUpURDFSidePolicy
...
if __name__ == "__main__":
    ...
    policy = PickUpURDFSidePolicy(franka, 'franka0', urdf, 'urdf0', n_envs, x_y_theta_tilt_dists)
    ...
    def save_urdf_pose(scene, t_step, t_sim, simulation_num):
        ...
        if settling_t_step == 150:
            ...
            elif t_step == settling_t_step + 249:
                for env_idx, env_ptr in enumerate(scene.env_ptrs):
            ...
            elif t_step == settling_t_step + 549:
                for env_idx, env_ptr in enumerate(scene.env_ptrs):
                    urdf_ah = scene.ah_map[env_idx]['urdf0']
