...
if __name__ == "__main__":
    ...
    success_model_file_path = prefix + 'pick_up_only_success_contingency_model_200.h5'
    failure_model_file_path = prefix + 'pick_up_only_failure_contingency_model_200.h5'
