...
if __name__ == "__main__":
    ...
    plt.hist(np.sum(data, axis=0), bins=50)
    plt.xlabel('Num Successes across 2000 skill parameters')
    ...
    for current_block_id in range(101):
        ...
        if np.sum(data[:,current_block_id]) > 5:
            skills_tested = []
        ...
        print(skill_probabilities.shape)
