...
if __name__ == "__main__":
    ...
    parser.add_argument('--urdf_dir_path', '-ud', type=str, default='assets/baseline_same_mass/')
    parser.add_argument('--yaml_dir_path', '-yd', type=str, default='cfg/paper/baseline_same_mass/')
    ...
    random_mass_number = 0 # np.random.random()
