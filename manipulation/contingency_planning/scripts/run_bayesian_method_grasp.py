...
if __name__ == "__main__":
    ...
    suffices = ['franka_fingers', 'tongs_overhead', 'tongs_side']
    skill_input_nums = [4, 4, 6]
    ...
    inputs = np.vstack((franka_x_y_thetas, tong_overhead_x_y_thetas, tong_side_x_y_theta_dist_tilts))
