...
from spatula_policies import PickUpURDFFlatPolicy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', '-dd', type=str, default='urdf_data/pick_up/spatula_flat/')
    ...
    if args.inputs is None:
        ...
        x_y_theta_dists = input_data['X']
        print(x_y_theta_dists.shape)
        ...
        if len(nonzero_trials[0]) == 0:
            ...
            x_y_theta_dists = x_y_theta_dists[nonzero_trials[0],:]
    ...
    policy = PickUpURDFFlatPolicy(franka, 'franka0', urdf, 'urdf0', n_envs, x_y_theta_dists)
    ...
    save_file_name = args.data_dir+urdf_name+'_spatula_flat.npz'
