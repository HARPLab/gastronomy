...
if __name__ == "__main__":
    ...
    parser.add_argument('--grasp_nn', type=str) #, default='same_blocks/pick_up/franka_fingers_pick_up_only_trained_model.h5')
    ...
    parser.add_argument('--data_dir', '-dd', type=str, default='same_blocks/pick_up/franka_fingers/')
