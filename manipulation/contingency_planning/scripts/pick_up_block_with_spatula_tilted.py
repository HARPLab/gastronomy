...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputs', '-i', type=str, default='data/spatula_tilted_inputs.npy')
    parser.add_argument('--block_num', '-b', type=int, default=22)
    parser.add_argument('--pan_num', '-p', type=int, default=0)
    parser.add_argument('--num_iterations', '-n', type=int, default=10000)
    parser.add_argument('--data_dir', '-dd', type=str, default='baseline_same_mass/pick_up/spatula_tilted/')
    ...
    policy = PickUpBlockTiltedPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_theta_dist_tilts)
