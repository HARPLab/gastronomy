...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_path', '-f', type=str, default='urdf_data/pick_up/tongs_side_convolution_data.npz')
    ...
    actions_train = actions[:500000,:]
    actions_test = actions[500000:,:]
    ...
    model.fit(my_training_batch_generator, validation_data=my_validation_batch_generator, epochs=3, verbose=True, shuffle=True)

    model.save('urdf_data/pick_up/tongs_side_convolution_model.h5')