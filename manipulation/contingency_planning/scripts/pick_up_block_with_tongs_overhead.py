...
from tong_policies import PickUpBlockTongsOverheadPolicy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--inputs', '-i', type=str, default='data/tongs_overhead_inputs.npy')
    parser.add_argument('--grasp_nn', type=str) #, default='baseline_same_mass/pick_up/tongs_overhead_pick_up_only_trained_model.h5')
    ...
    parser.add_argument('--data_dir', '-dd', type=str, default='baseline_same_mass/pick_up/tongs_overhead/')
    ...
    if args.inputs is None:
        if args.grasp_nn is None:
            ...
            np.save('same_blocks/pick_up/tongs_overhead_inputs.npy', x_y_thetas)
    else:
    ...
    policy = PickUpBlockTongsOverheadPolicy(franka, 'franka0', block, 'block0', n_envs, x_y_thetas)
    ...
    save_file_name = args.data_dir+'block'+str(args.block_num)+'_pick_up_block_with_tongs_overhead.npz'
