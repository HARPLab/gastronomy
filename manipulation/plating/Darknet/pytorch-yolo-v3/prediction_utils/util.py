...
from prediction_utils.bbox import bbox_iou
...
def write_results(prediction, confidence, num_classes, nms = True, nms_conf = 0.4):
    ...
    for ind in range(batch_size):
        ...
        # #TODO added these three lines to fix an issue with tensor sizing
    ...
    # #TODO tried adding this to fix fimension issues
