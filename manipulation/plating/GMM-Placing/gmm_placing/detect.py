...
from gmm_placing.preprocess import prep_image, inp_to_image
from gmm_placing.darknet import Darknet
from gmm_placing.yolo_utils import *
...
if __name__ ==  '__main__':
    ...
    colors = pkl.load(open("../misc/pallete", "rb"))
