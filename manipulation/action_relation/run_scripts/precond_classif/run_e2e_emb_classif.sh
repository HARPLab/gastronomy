...
args=(
  ...
  --result_dir /home/mohit/experiment_results/robot_interface_utils/action_relation_voxel/precond_classif/classify_from_emb_e2e_can_move_dist/Oct_17_data_1/cml_2_action_index_0_2_4_6_input_1000/use_init_lr_0.0_classif_lr_0.0003_Oct_24_2_15_PM/
  ...
  --train_dir ~/datasets/vrep_data/relation_on_drop/precond_data/can_move_dist/train/
  --test_dir ~/datasets/vrep_data/relation_on_drop/precond_data/can_move_dist/test/
...
python -m ipdb ./action_relation/trainer/train_voxel_precond_e2e.py "${args[@]}"
