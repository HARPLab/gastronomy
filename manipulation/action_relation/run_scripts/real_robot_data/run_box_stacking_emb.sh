...
args=(
  ...
  --result_dir /tmp/experiment_results/robot_interface_utils/action_relation_voxel/real_robot_data/box_stacking/factored_scene/loss_pred_contrastive/lr_0.0003_train_3_4_test_5_Dec_27_6_00_PM
  ...
  --test_dir ~/datasets/robot_data/action_based_relation/block_stacking/try_1_Dec_24/split_2/4_obj/test
  # --test_dir ~/datasets/robot_data/action_based_relation/block_stacking/try_1_Dec_24/split_2/5_obj

  # --train_type 'unfactored_scene'
  # --train_type 'unfactored_scene_resnet18'

  --train_type 'all_object_pairs_g_f_ij_attn'
