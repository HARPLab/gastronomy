...
args=(
  ...
  --result_dir /tmp/experiment_results/robot_interface_utils/action_relation_voxel/real_robot_data/cut_food/factored_scene/only_contrastive_loss/lr_0.0003_train_0_1_test_3_Dec_23_7_40_PM
  --save_embedding_only 0

  # Small simple model
  --emb_checkpoint_path /tmp/experiment_results/robot_interface_utils/action_relation_voxel/vrep_robot_data/Dec_18_scene_4_orient_change_relative_action/orient_change_dataloader/small_simple_model_nouse_bb_input_no_contact_no_ft/use_contrastive_loss_gt_pos_0.2_orient_0.005_margin_pos_2.0_orient_2.0/l2_loss_use_add_xy_channels_batch_128_lr_0.0003_pos_0.0_orient_0.0_triplet_10._orient_10.0_Dec_23_3_55_PM/checkpoint/cp_7500.pth
  --emb_save_path /tmp/experiment_results/robot_interface_utils/action_relation_voxel/vrep_robot_data/Dec_18_scene_4_orient_change_relative_action/orient_change_dataloader/small_simple_model_nouse_bb_input_no_contact_no_ft/use_contrastive_loss_gt_pos_0.2_orient_0.005_margin_pos_2.0_orient_2.0/l2_loss_use_add_xy_channels_batch_128_lr_0.0003_pos_0.0_orient_0.0_triplet_10._orient_10.0_Dec_23_3_55_PM/real_robot_emb/data_cut_food


  # ResNet18 embedding
  # --emb_checkpoint_path /tmp/experiment_results/robot_interface_utils/action_relation_voxel/vrep_robot_data/Dec_18_scene_4_orient_change_relative_action/orient_change_dataloader/resnet_model_nouse_bb_input_no_contact_no_ft/use_contrastive_loss_gt_pos_0.2_orient_0.005_margin_pos_2.0_orient_2.0/l2_loss_use_add_xy_channels_batch_128_lr_0.0003_pos_0.0_orient_0.0_triplet_10._orient_10.0_Dec_23_3_55_PM/checkpoint/cp_11000.pth
  # --emb_checkpoint_path /tmp/experiment_results/robot_interface_utils/action_relation_voxel/vrep_robot_data/Dec_18_scene_4_orient_change_relative_action/orient_change_dataloader/resnet_model_nouse_bb_input_no_contact_no_ft/use_contrastive_loss_gt_pos_0.2_orient_0.005_margin_pos_2.0_orient_2.0/l2_loss_use_add_xy_channels_batch_128_lr_0.0003_pos_0.0_orient_0.0_triplet_10._orient_10.0_Dec_23_3_55_PM/real_robot_emb/data_cut_food
