...
args=(
  ...
  --result_dir /tmp/experiment_results/robot_interface_utils/action_relation_voxel/real_robot_data/box_stacking/factored_scene_gnn/loss_pred_contrastive/weight_bce_batch_16_no_stable_loss_use_backbone_frozen_emb_lr_0.0003_train_3_4_test_6_Dec_29_7_20_PM
  ...
  --train_type 'all_object_pairs_gnn'
