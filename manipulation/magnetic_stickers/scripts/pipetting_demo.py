...
def run_main():
    ...
    test_tube_1 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.54359048, 0.17224207, 0.20106597]),
                                    from_frame='franka_tool', to_frame='world')
    test_tube_2 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.54359048, 0.19764207, 0.20106597]),
                                    from_frame='franka_tool', to_frame='world')
    test_tube_3 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.54359048, 0.22304207, 0.20106597]),
                                    from_frame='franka_tool', to_frame='world')
    ...
    relative_pos_dist_y = RigidTransform(rotation=np.array([
                                                ...
                                                [0,  1,  0],
                                                [0,  0,  1]
                                            ]), translation=np.array([0.0, 0.20, 0.0]),
                                        from_frame='franka_tool', to_frame='franka_tool')
