...
if __name__ == '__main__':
    ...
    starting_location = [correct_x, constant_y, correct_z]
    ...
    for i in range(2):
        ...
        desired_object_pose = RigidTransform(
            rotation=np.array([[1, 0,  0],
                               [0,  -1,  0],
                               [0, 0,  -1]]), 
            translation=np.array([correct_x+x_scan_dist, constant_y, correct_z]),
             from_frame='franka_tool', to_frame='world')
        ...
        guess_prm = [400, max_location[0], 0.01, np.mean(zdata)]

        # Do the fit, using our custom _gaussian function which understands our
        # flattened (ravelled) ordering of the data points.
        popt, pcov = curve_fit(func, xdata, zdata, p0=guess_prm, maxfev=1000000)
        ...
        current_location = [popt[1], constant_y, correct_z]
        ...
        rotation=np.array([[1, 0,  0],
                           [0,  -1,  0],
                           [0, 0,  -1]]), 
        translation=np.array([correct_x, constant_y, correct_z+z_scan_dist]),
         from_frame='franka_tool', to_frame='world')
        ...
        current_location = [correct_x, constant_y, popt[1]]
