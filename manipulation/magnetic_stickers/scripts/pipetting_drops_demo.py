...
class MagneticCalibration:
    def __init__(self):
        ...
        self.max_data_time = 200 # 10 seconds
...
def run_main():
    ...
    pipette_rotation = np.array([[1, 0,  0],
                                 [0,  -1,  0],
                                 [0, 0,  -1]])

    initial_magnet_position1 = RigidTransform(rotation=pipette_rotation, 
                                    translation=np.array([0.45683638, 0.06513334, 0.20451204]),
                                    from_frame='franka_tool', to_frame='world')

    initial_magnet_position2 = RigidTransform(rotation=pipette_rotation, 
                                    translation=np.array([0.45683638, 0.06513334, 0.15451204]),
                                    from_frame='franka_tool', to_frame='world')

    initial_magnet_position3 = RigidTransform(rotation=pipette_rotation, 
                                    translation=np.array([0.45683638, 0.06513334, 0.33451204]),
                                    from_frame='franka_tool', to_frame='world')

    beaker_position1 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.44724006, 0.2870516,  0.33210899]),
                                    from_frame='franka_tool', to_frame='world')

    beaker_position2 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.44724006, 0.2870516,  0.16210899]),
                                    from_frame='franka_tool', to_frame='world')

    test_tube_1 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.54359048, 0.17224207, 0.19106597]),
                                    from_frame='franka_tool', to_frame='world')
    test_tube_2 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.56359048, 0.17224207, 0.19106597]),
                                    from_frame='franka_tool', to_frame='world')
    test_tube_3 = RigidTransform(rotation=pipette_rotation, translation=np.array([0.58359048, 0.17224207, 0.19106597]),
                                    from_frame='franka_tool', to_frame='world')
    ...
    relative_pos_dist_y = RigidTransform(rotation=np.array([
                                                ...
                                                [0,  1,  0],
                                                [0,  0,  1]
                                            ]), translation=np.array([0.0, 0.02, 0.0]),
                                        from_frame='franka_tool', to_frame='franka_tool')
    ...
    if args.filename is not None:
        magnetic_calibration.saveData(args.filename, global_max, min_gripper_width)
