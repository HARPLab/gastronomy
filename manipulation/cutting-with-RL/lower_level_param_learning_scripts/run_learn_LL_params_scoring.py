''' Notes: 
Notes: Script for running lower level parameter learning experiments for scoring skill
    ...
    for epoch in range(args.starting_epoch_num, args.num_epochs):
        ...
        for sample in range(args.starting_sample_num, args.num_samples):
            ...
            if args.use_all_dmp_dims:  
                ...
                # trying outmore generalized cutting reward function - remove not returning to start penalty:
