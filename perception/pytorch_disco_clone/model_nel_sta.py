    ...
    def forward(self, feed):
        ...
        if hyp.imgnet:
            ...
            if hyp.imgnet_v1:
                ...
                rgb_pret = rgb_pret.reshape([hyp.B,hyp.S,192,64,64])
        ...
        if hyp.dataset_name == "carla":
            ...
            # gt_boxesR = nlu.get_ends_of_corner(gt_boxesR_corners).cpu().numpy()
        ...
        if hyp.max.do and  hyp.max.predicted_matching:
            ...
            # summ_writer.summ_box_mem_on_mem('eval_boxes/gt_boxesX0_mem', unp_vis , gt_boxesX0Mem_theta, torch.ones(hyp.B,N),tids)
            # summ_writer.summ_box_mem_on_mem('eval_boxes/gt_boxesR_mem', unp_visRs , gt_boxesRMem_theta, torch.ones(hyp.B,N),tids)
