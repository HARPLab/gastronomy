...
export TMPDIR=/tmp/$USER; mkdir -p $TMPDIR; tensorboard --port=${PORT_NUM} --logdir=${LOG_DIR} --host localhost --samples_per_plugin images=10000 --samples_per_plugin text=10000
# else
