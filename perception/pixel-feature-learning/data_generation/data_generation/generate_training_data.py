...
def main():
    model_files = [
        '/home/zhouxian/projects/sony_cooking/data/processed/Broccoli_obj/Broccoli.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/cabbage_obj/cabbage.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/cheese_01-obj/cheese_01.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/cheese_03-obj/cheese_03.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/Cucumber_obj/Cucumber.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/egg_obj/egg.obj',
        '/home/zhouxian/projects/sony_cooking/data/processed/jalapeno_pepper_obj/Jalapeno_Pepper.obj'
    ]
    dataset_config_dir = '/home/zhouxian/git/pytorch-dense-correspondence/config/dense_correspondence/dataset/'
    output_root_dir = "/home/zhouxian/git/pytorch-dense-correspondence/pdc/logs_proto/cooking/"
    scales = [0.001, 0.0006, 0.02, 0.007, 0.0015, 0.18, 0.0017]

    composite_yaml_data = {
        'logs_root_path': '/home/zhouxian/git/pytorch-dense-correspondence/pdc/logs_proto/cooking',
    ...
    for i, model_file in enumerate(model_files):
        ...
        composite_yaml_data['single_object_scenes_config_files'].append(model_name+'.yaml')
        single_yaml_data = {
            'logs_root_path': '/home/zhouxian/git/pytorch-dense-correspondence/pdc/logs_proto/cooking',
        ...
        mesh_orientation = p.getQuaternionFromEuler([0,0,0])
        ...
        # taking pictures
        for scene in [1, 2, 3]:
            scene_name = model_name + '_' + str(scene)
            single_yaml_data['train'].append(scene_name)
            single_yaml_data['test'].append(scene_name)
            depth_data = dict()
            depth_data['msgs'] = []
            depth_data['cv_img'] = []
            ...
            pose_data = dict()
            output_dir = os.path.join(output_root_dir, scene_name, 'processed')
        ...
        spartan_utils.saveToYaml(single_yaml_data, os.path.join(dataset_config_dir, 'single_object/'+model_name+'.yaml'))
        p.resetSimulation()
    spartan_utils.saveToYaml(composite_yaml_data, os.path.join(dataset_config_dir, 'composite/cooking.yaml'))
    p.disconnect()
